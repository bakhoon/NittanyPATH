...
#             get_phone = '(' + get_number[0:3] + ')' + \
#                 get_number[3:6] + '-' + get_number[6:10]
#             if len(get_name) > 2:
...
#             database = [get_id[0], secretp, get_honorific, get_fname, get_lname, get_degree,
#                         get_others, row1[2], row1[5], row1[10], get_phone, row1[9], row1[3]]
...
#             secretp = pwhashed.hexdigest()
#             database = [get_id[0], secretp, get_honorific, get_fname, get_lname, get_degree,
#                         get_others, row[2], row[5], row[10], get_phone, row[9], row[3], row[47]]
#             cursor.execute(
...
#             secretp = pwhashed.hexdigest()
#             database = [get_id[0], secretp, get_name[1], get_name[2],
#                         row[3], row[4], get_office[0], get_office[1], row[5], row[8]]
#             cursor.execute(
...
#     cursor.execute(
#         'CREATE TABLE IF NOT EXISTS Departments(did VARCHAR(5) NOT NULL PRIMARY KEY, dname VARCHAR(36), head_email VARCHAR(8), UNIQUE(did));')
#     reader = csv.reader(open("Professors.csv", "r"))
#     dept = []
#     title = None
#     for row in reader:
...
#     cursor.execute(
#         'CREATE TABLE IF NOT EXISTS TA_teach(semail VARCHAR(8), teaching_team_id INTEGER);')
#     reader = csv.reader(open("Students_TA.csv", "r"))
#     for row in reader:
#         if row[47] == '' or row[0] == 'Full Name':
#             pass
...
#     cursor.execute(
#         'CREATE TABLE IF NOT EXISTS Professor_teach(pemail VARCHAR(8), teaching_team_id INTEGER);')
#     reader = csv.reader(open("Professors.csv", "r"))
#     for row in reader:
#         if row[0] == 'Name':
#             pass
...
#     cursor.execute(
#         'CREATE TABLE IF NOT EXISTS Homeworks(cid VARCHAR(12), sec_no INTEGER, hw_no INTEGER, hwdesc VARCHAR(99));')
#     homeworks = []
#     reader = csv.reader(open("Students_TA.csv", "r"))
#     for row in reader:
#         if row[0] == 'Full Name':
...
#     cursor.execute(
#         'CREATE TABLE IF NOT EXISTS Exams(cid VARCHAR(12), sec_no INTEGER, exam_no INTEGER, examdesc VARCHAR(99));')
#     exams = []
#     reader = csv.reader(open("Students_TA.csv", "r"))
#     for row in reader:
#         if row[0] == 'Full Name':
